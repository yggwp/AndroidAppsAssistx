        ...
        viewModelScope.launch {
            ...
            try {
                ...
                _summary.value = AnalyticsSummaryUi(
                    labels = result.labels ?: emptyList(),
                    onlineCounts = result.online_counts ?: emptyList(),
                    offlineCounts = result.offline_counts ?: emptyList(),
                    avgCpus = result.avg_cpu ?: emptyList(),
                    avgMems = result.avg_memory ?: emptyList(),
                    avgStorages = result.avg_storage ?: emptyList()
                )
            } catch (e: Exception) {
