...
class SettingsViewModel : ViewModel() {
    ...
    val authUsername: Flow<String> = prefs.authUsername
    val authPassword: Flow<String> = prefs.authPassword
    ...
    fun setCredentials(username: String, password: String) {
        viewModelScope.launch { prefs.setCredentials(username, password) }
    }
