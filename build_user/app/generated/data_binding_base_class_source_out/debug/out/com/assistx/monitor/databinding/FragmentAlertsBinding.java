...
public final class FragmentAlertsBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout alertHeader;
  ...
  private FragmentAlertsBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout alertHeader, @NonNull LinearLayout emptyState,
      @NonNull RecyclerView rvAlerts, @NonNull TextView tvAlertCount) {
  ...
  public static FragmentAlertsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.alertHeader;
      LinearLayout alertHeader = ViewBindings.findChildViewById(rootView, id);
      if (alertHeader == null) {
        break missingId;
      }
      ...
      return new FragmentAlertsBinding((ConstraintLayout) rootView, alertHeader, emptyState,
          rvAlerts, tvAlertCount);
    }
